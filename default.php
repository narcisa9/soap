...
<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="https://www.hostinger.ro/"><img src="https://raw.githubusercontent.com/hostinger/banners/master/hostinger_welcome/images/hostinger-logo.png" width="120"></a>
        </div>
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav navbar-right">
                <li>
                    <a href="https://www.hostinger.com/tutorials"><i aria-hidden="true" class="fa fa-graduation-cap"></i> Tutoriale</a>
                </li>
                <li>
                    <a href="https://www.hostinger.ro/make-money-online"><i aria-hidden="true" class="fa fa-trophy"></i> Câștigă cu noi</a>
                </li>
                <li>
                    <a href="https://www.hostinger.ro/affiliate-program/login"><i aria-hidden="true" class="fa fa-user"></i> Afiliați</a>
                </li>
                <li>
                    <a href="https://cpanel.hostinger.ro"><i aria-hidden="true" class="fa fa-lock"></i> Autentificare</a>
                </li>
            </ul>
        </div>
    </div>
...
<div class="empty-account-page">
    <div class="container">
        <div class="row congratz">
            <h1>Contul tău a fost creat!</h1><i></i>
        ...
        <div class="column-wrap clearfix">
            ...
            <div class="col-xs-12 col-sm-4 column-custom-wrap">
                <div class="column-custom">
                    ...
                    <br>
                    <a href="https://www.hostinger.ro/castiga-bani-online">Află mai multe</a>
                </div>
            </div>
            <div class="col-xs-12 col-sm-4 column-custom-wrap">
                <div class="column-custom">
                    ...
                    <br>
                    <a href="https://www.hostinger.ro/baza-cunostinte">Află mai multe</a>
                </div>
            </div>
            <div class="col-xs-12 col-sm-4 column-custom-wrap">
                <div class="column-custom">
                    ...
                    <br>
                    <a href="https://www.hostinger.com/blog/">Află mai multe</a>
                </div>
            </div>
        </div>
        ...
        <div class="footer">
            <div class="row">
                <div class="text-center" style="margin-bottom: 10px;">
                    <a href="https://www.hostinger.ro/gazduire-web">Găzduire web</a> |
                    <a href="https://cpanel.hostinger.ro">Conectare client</a>
                </div>
                <div class="copyright text-center">
                    Hostinger © 2017. Toate drepturile rezervate.
                </div>
            </div>
        </div>
    </div>
